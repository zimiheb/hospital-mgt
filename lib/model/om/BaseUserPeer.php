...
abstract class BaseUserPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'RoleId', 'EmployeeId', 'User', 'Password', 'Status', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'roleId', 'employeeId', 'user', 'password', 'status', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::ROLE_ID, self::EMPLOYEE_ID, self::USER, self::PASSWORD, self::STATUS, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'role_id', 'employee_id', 'user', 'password', 'status', 'created_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'RoleId' => 1, 'EmployeeId' => 2, 'User' => 3, 'Password' => 4, 'Status' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'roleId' => 1, 'employeeId' => 2, 'user' => 3, 'password' => 4, 'status' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::ROLE_ID => 1, self::EMPLOYEE_ID => 2, self::USER => 3, self::PASSWORD => 4, self::STATUS => 5, self::CREATED_AT => 6, self::UPDATED_AT => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'role_id' => 1, 'employee_id' => 2, 'user' => 3, 'password' => 4, 'status' => 5, 'created_at' => 6, 'updated_at' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(UserPeer::EMPLOYEE_ID);

		$criteria->addSelectColumn(UserPeer::USER);
	...
	public static function doCountJoinRole(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(UserPeer::ROLE_ID,), array(RolePeer::ID,), $join_behavior);
	...
	public static function doCountJoinEmployee(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(UserPeer::EMPLOYEE_ID,), array(EmployeePeer::ID,), $join_behavior);
	...
	/**
	 * Selects a collection of User objects pre-filled with their Employee objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of User objects.
	...
	public static function doSelectJoinEmployee(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (User) to $obj2 (Employee)
				$obj2->addUser($obj1);
      ...
      call_user_func($callable, 'BaseUserPeer', $c, $con);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (User) to the collection in $obj3 (Employee)
				$obj3->addUser($obj1);
			} // if joined row not null
