...
abstract class BaseEmployee extends BaseObject  implements Persistent {
  ...
  const PEER = 'EmployeePeer';
	...
	/**
	 * The value for the visit_fee field.
	 * @var        int
	 */
	protected $visit_fee;
	...
	/**
	 * Get the [visit_fee] column value.
	 * 
	 * @return     int
	 */
	...
	/**
	 * Set the value of [visit_fee] column.
	 * 
	 * @param      int $v new value
	 * @return     Employee The current object (for fluent API support)
	 */
	public function setVisitFee($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}
		...
		if ($this->visit_fee !== $v) {
			$this->visit_fee = $v;
			$this->modifiedColumns[] = EmployeePeer::VISIT_FEE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->visit_fee = ($row[$startcol + 17] !== null) ? (int) $row[$startcol + 17] : null;
			...
			return $startcol + 21; // 21 = EmployeePeer::NUM_COLUMNS - EmployeePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[17], $arr)) $this->setVisitFee($arr[$keys[17]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(EmployeePeer::VISIT_FEE)) $criteria->add(EmployeePeer::VISIT_FEE, $this->visit_fee);
