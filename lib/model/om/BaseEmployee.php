  ...
  const PEER = 'EmployeePeer';
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->cnic = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->dob = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->gender = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->mail_address = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			...
			$this->contact_off = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
			$this->emergency_contact = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
			$this->employment_date = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
			$this->local_resident = ($row[$startcol + 13] !== null) ? (string) $row[$startcol + 13] : null;
			...
			return $startcol + 18; // 18 = EmployeePeer::NUM_COLUMNS - EmployeePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[7] => $this->getMailAddress(),
			$keys[8] => $this->getContactRes(),
			$keys[9] => $this->getContactCell(),
			$keys[10] => $this->getContactOff(),
			$keys[11] => $this->getEmergencyContact(),
			$keys[12] => $this->getEmploymentDate(),
			$keys[13] => $this->getLocalResident(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setCnic($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setDob($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setGender($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setMailAddress($arr[$keys[7]]);
		...
		if (array_key_exists($keys[10], $arr)) $this->setContactOff($arr[$keys[10]]);
		if (array_key_exists($keys[11], $arr)) $this->setEmergencyContact($arr[$keys[11]]);
		if (array_key_exists($keys[12], $arr)) $this->setEmploymentDate($arr[$keys[12]]);
		if (array_key_exists($keys[13], $arr)) $this->setLocalResident($arr[$keys[13]]);
