...
abstract class BaseWardBed extends BaseObject  implements Persistent {
  ...
  const PEER = 'WardBedPeer';
	...
	public function setPrice($v)
	{
		...
		if ($this->price !== $v) {
			$this->price = $v;
			$this->modifiedColumns[] = WardBedPeer::PRICE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = WardBedPeer::NUM_COLUMNS - WardBedPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(WardBedPeer::PRICE)) $criteria->add(WardBedPeer::PRICE, $this->price);
