...
abstract class BaseLabTest extends BaseObject  implements Persistent {
  ...
  const PEER = 'LabTestPeer';
	...
	public function setPrice($v)
	{
		...
		if ($this->price !== $v) {
			$this->price = $v;
			$this->modifiedColumns[] = LabTestPeer::PRICE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 7; // 7 = LabTestPeer::NUM_COLUMNS - LabTestPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LabTestPeer::PRICE)) $criteria->add(LabTestPeer::PRICE, $this->price);
	 ...
	 * Otherwise if this LabTest has previously been saved, it will retrieve
	 * related LabReports from storage. If this LabTest is new, it will return
		...
		if ($this->collLabReports === null) {
			if ($this->isNew()) {
			   $this->collLabReports = array();
				...
				$criteria->add(LabReportPeer::LAB_TEST_ID, $this->id);
	 ...
	 * Otherwise if this LabTest is new, it will return
	 * an empty collection; or if this LabTest has previously
	 * been saved, it will retrieve related LabReports from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in LabTest.
	 */
