...
<div id="main_content">
	...
	<div class="box_title">
		<h2><span class="dark_blue">Dosage Information</span></h2>
		<span style="float:right"><?php echo image_tag('icon_addRight.jpg', 'width="2"', 'height="22"')?></span>
			<a class="addNew" id="popup_link_add" href="#">Add New Dosage</a>
		</h2>
	</div>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="datagrid">
			  ...
			  <tr>
				<th style="text-align:left";>Dosage Name</th>
			 ...
			 <!-- Populating the List -->
              ...
              <tr>
                <td align="left"><?php echo $dosage->getTitle(); ?> </td>
				<td align="center"><?php echo Constant::GetRecordStatusTitle($dosage->getStatus()); ?></td>
			
				<td align="right">
				<?php echo link_to('&nbsp;','Dosage/edit?id='.Utility::EncryptQueryString($dosage->getId()),array('title'=>'Edit', 'class' => 'edit'))?>
				
				<?php echo link_to('&nbsp;','Dosage/delete?id='.Utility::EncryptQueryString($dosage->getId()), array('confirm'=>'Are you sure you want to Delete this?', 'title'=>'Delete', 'class' => 'delete')); ?>
				</td>
              </tr>
...
<?php echo form_tag('Dosage/add') ?>

<table width="100%" border="0" cellspacing="0" cellpadding="0" class="form">
  <tr>
    <td style="padding-left:10px" height="30"><span class="heading">Add New Dosage</span></td>
...
<table width="100%"  cellpadding="0" cellspacing="0" align="left" border="0" class="form" bgcolor="#eeeeee">
  ...
  <tr>
    <td width="155" align="left" height="30" style="padding-left:10px; padding-top:10px">Dosage Name:<span class="error"> *</span></td>
