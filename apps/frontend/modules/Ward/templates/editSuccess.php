...
<?php echo form_tag('Ward/edit') ?>
<?php echo input_hidden_tag('id', $ward->getId()) ?>

<div id="main_content">
	<div class="box_content">
	<div class="box_title">
	<h2><span class="dark_blue">Edit Ward Information</span></h2>
	</div>
...
<table width="100%" cellpadding="0" cellspacing="0"  align="left" border="0">
  ...
  <tr>
    <td width="16%" height="30">Ward Name:<span class="error"> *</span> </td>
    <td width="84%" height="30"><?php echo input_tag ('title', $ward->getTitle(),'size=38'); ?>
