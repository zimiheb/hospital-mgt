...
<tr>
	...
	<td width="2%">&nbsp;</td>
	<!--<td width="20%" height="10" class="boysSec"><h2>Academics</h2></td>
	<td width="2%">&nbsp;</td>
...
<!--<tr>
	...
	<td height="40" class="boysSec">&nbsp;&nbsp;<?php echo link_to('Academic Session' ,'Session/list',array('class'=>'link')); ?></td>
	
	<td width="2%">&nbsp;</td>
	
	<td height="40" class="boysSec">&nbsp;&nbsp;<?php echo link_to('Inventory Location For Office' ,'InventoryLocation/listLocationOffice',array('class'=>'link')); ?></td>
...
<!--<tr>
	...
	<td height="40" class="boysSec">&nbsp;&nbsp;<?php echo link_to('Academic Subjects' ,'Subject/list',array('class'=>'link')); ?></td>
	
	<td width="2%">&nbsp;</td>
		
	<td height="40" class="boysSec">&nbsp;&nbsp;<?php echo link_to('Intentory Item Listing of Office' ,'InventoryItem/listItemOffice',array('class'=>'link')); ?></td>
