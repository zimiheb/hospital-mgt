 ...
 */
abstract class BaseStaff extends BaseObject  implements Persistent {


  const PEER = 'StaffPeer';
	...
	/**
	 * Initializes internal state of BaseStaff object.
	 * @see        applyDefaults()
	 */
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = StaffPeer::ID;
		}
	...
	public function setDepartmentId($v)
	{
		...
		if ($this->department_id !== $v) {
			...
			$this->modifiedColumns[] = StaffPeer::DEPARTMENT_ID;
		}
	...
	public function setDesignationId($v)
	{
		...
		if ($this->designation_id !== $v) {
			...
			$this->modifiedColumns[] = StaffPeer::DESIGNATION_ID;
		}
	...
	public function setRoleId($v)
	{
		...
		if ($this->role_id !== $v) {
			$this->role_id = $v;
			$this->modifiedColumns[] = StaffPeer::ROLE_ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = StaffPeer::NAME;
		}
	...
	public function setCnic($v)
	{
		...
		if ($this->cnic !== $v) {
			$this->cnic = $v;
			$this->modifiedColumns[] = StaffPeer::CNIC;
		}
	...
	public function setDob($v)
	{
		...
		if ( $this->dob !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = StaffPeer::DOB;
			}
	...
	public function setGender($v)
	{
		...
		if ($this->gender !== $v) {
			$this->gender = $v;
			$this->modifiedColumns[] = StaffPeer::GENDER;
		}
	...
	public function setPermanentAddress($v)
	{
		...
		if ($this->permanent_address !== $v) {
			...
			$this->modifiedColumns[] = StaffPeer::PERMANENT_ADDRESS;
		}
	...
	public function setContactRes($v)
	{
		...
		if ($this->contact_res !== $v) {
			$this->contact_res = $v;
			$this->modifiedColumns[] = StaffPeer::CONTACT_RES;
		}
	...
	public function setContactCell($v)
	{
		...
		if ($this->contact_cell !== $v) {
			$this->contact_cell = $v;
			$this->modifiedColumns[] = StaffPeer::CONTACT_CELL;
		}
	...
	public function setContactOff($v)
	{
		...
		if ($this->contact_off !== $v) {
			$this->contact_off = $v;
			$this->modifiedColumns[] = StaffPeer::CONTACT_OFF;
		}
	...
	public function setEmergencyContact($v)
	{
		...
		if ($this->emergency_contact !== $v) {
			...
			$this->modifiedColumns[] = StaffPeer::EMERGENCY_CONTACT;
		}
	...
	public function setEmploymentDate($v)
	{
		...
		if ( $this->employment_date !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = StaffPeer::EMPLOYMENT_DATE;
			}
		} // if either are not null
	...
	public function setLocalResident($v)
	{
		...
		if ($this->local_resident !== $v) {
			...
			$this->modifiedColumns[] = StaffPeer::LOCAL_RESIDENT;
		}
	...
	public function setQualification($v)
	{
		...
		if ($this->qualification !== $v) {
			...
			$this->modifiedColumns[] = StaffPeer::QUALIFICATION;
		}
	...
	public function setStatus($v)
	{
		...
		if ($this->status !== $v) {
			$this->status = $v;
			$this->modifiedColumns[] = StaffPeer::STATUS;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = StaffPeer::CREATED_AT;
			}
		} // if either are not null
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = StaffPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 19; // 19 = StaffPeer::NUM_COLUMNS - StaffPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating Staff object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = StaffPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseStaff:delete:pre') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseStaff:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseStaff:save:pre') as $callable)
    {
    ...
    if ($this->isNew() && !$this->isColumnModified(StaffPeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
    }

    if ($this->isModified() && !$this->isColumnModified(StaffPeer::UPDATED_AT))
    {
      $this->setUpdatedAt(time());
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseStaff:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			StaffPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = StaffPeer::doInsert($this, $con);
					...
					$affectedRows += StaffPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = StaffPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = StaffPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = StaffPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(StaffPeer::ID)) $criteria->add(StaffPeer::ID, $this->id);
		if ($this->isColumnModified(StaffPeer::DEPARTMENT_ID)) $criteria->add(StaffPeer::DEPARTMENT_ID, $this->department_id);
		if ($this->isColumnModified(StaffPeer::DESIGNATION_ID)) $criteria->add(StaffPeer::DESIGNATION_ID, $this->designation_id);
		if ($this->isColumnModified(StaffPeer::ROLE_ID)) $criteria->add(StaffPeer::ROLE_ID, $this->role_id);
		if ($this->isColumnModified(StaffPeer::NAME)) $criteria->add(StaffPeer::NAME, $this->name);
		if ($this->isColumnModified(StaffPeer::CNIC)) $criteria->add(StaffPeer::CNIC, $this->cnic);
		if ($this->isColumnModified(StaffPeer::DOB)) $criteria->add(StaffPeer::DOB, $this->dob);
		if ($this->isColumnModified(StaffPeer::GENDER)) $criteria->add(StaffPeer::GENDER, $this->gender);
		if ($this->isColumnModified(StaffPeer::PERMANENT_ADDRESS)) $criteria->add(StaffPeer::PERMANENT_ADDRESS, $this->permanent_address);
		if ($this->isColumnModified(StaffPeer::CONTACT_RES)) $criteria->add(StaffPeer::CONTACT_RES, $this->contact_res);
		if ($this->isColumnModified(StaffPeer::CONTACT_CELL)) $criteria->add(StaffPeer::CONTACT_CELL, $this->contact_cell);
		if ($this->isColumnModified(StaffPeer::CONTACT_OFF)) $criteria->add(StaffPeer::CONTACT_OFF, $this->contact_off);
		if ($this->isColumnModified(StaffPeer::EMERGENCY_CONTACT)) $criteria->add(StaffPeer::EMERGENCY_CONTACT, $this->emergency_contact);
		if ($this->isColumnModified(StaffPeer::EMPLOYMENT_DATE)) $criteria->add(StaffPeer::EMPLOYMENT_DATE, $this->employment_date);
		if ($this->isColumnModified(StaffPeer::LOCAL_RESIDENT)) $criteria->add(StaffPeer::LOCAL_RESIDENT, $this->local_resident);
		if ($this->isColumnModified(StaffPeer::QUALIFICATION)) $criteria->add(StaffPeer::QUALIFICATION, $this->qualification);
		if ($this->isColumnModified(StaffPeer::STATUS)) $criteria->add(StaffPeer::STATUS, $this->status);
		if ($this->isColumnModified(StaffPeer::CREATED_AT)) $criteria->add(StaffPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(StaffPeer::UPDATED_AT)) $criteria->add(StaffPeer::UPDATED_AT, $this->updated_at);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(StaffPeer::ID, $this->id);
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseStaff:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseStaff::%s', $method));
    }
