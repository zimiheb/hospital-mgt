...
abstract class BaseRoom extends BaseObject  implements Persistent {
  ...
  const PEER = 'RoomPeer';
	...
	public function setPrice($v)
	{
		...
		if ($this->price !== $v) {
			$this->price = $v;
			$this->modifiedColumns[] = RoomPeer::PRICE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 7; // 7 = RoomPeer::NUM_COLUMNS - RoomPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(RoomPeer::PRICE)) $criteria->add(RoomPeer::PRICE, $this->price);
