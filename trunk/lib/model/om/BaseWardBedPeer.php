...
abstract class BaseWardBedPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'WardId', 'Bed', 'Price', 'Status', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'wardId', 'bed', 'price', 'status', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::WARD_ID, self::BED, self::PRICE, self::STATUS, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'ward_id', 'bed', 'price', 'status', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'WardId' => 1, 'Bed' => 2, 'Price' => 3, 'Status' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'wardId' => 1, 'bed' => 2, 'price' => 3, 'status' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::WARD_ID => 1, self::BED => 2, self::PRICE => 3, self::STATUS => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'ward_id' => 1, 'bed' => 2, 'price' => 3, 'status' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(WardBedPeer::PRICE);
