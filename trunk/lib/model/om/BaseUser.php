  ...
  const PEER = 'UserPeer';
	...
	public function setEmployeeId($v)
	{
		...
		if ($this->employee_id !== $v) {
			$this->employee_id = $v;
			$this->modifiedColumns[] = UserPeer::EMPLOYEE_ID;
		}
	...
	public function setUser($v)
	{
		...
		if ($this->user !== $v) {
			$this->user = $v;
			$this->modifiedColumns[] = UserPeer::USER;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(UserPeer::EMPLOYEE_ID)) $criteria->add(UserPeer::EMPLOYEE_ID, $this->employee_id);
		if ($this->isColumnModified(UserPeer::USER)) $criteria->add(UserPeer::USER, $this->user);
