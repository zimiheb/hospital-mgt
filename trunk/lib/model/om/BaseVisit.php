...
abstract class BaseVisit extends BaseObject  implements Persistent {
  ...
  const PEER = 'VisitPeer';
	...
	public function setRoomId($v)
	{
		...
		if ($this->room_id !== $v) {
			$this->room_id = $v;
			$this->modifiedColumns[] = VisitPeer::ROOM_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->room_id = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
			$this->visit_type = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			...
			$this->diet = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
			...
			$this->visit_date = ($row[$startcol + 13] !== null) ? (string) $row[$startcol + 13] : null;
			$this->admit_date = ($row[$startcol + 14] !== null) ? (string) $row[$startcol + 14] : null;
			$this->discharge_date = ($row[$startcol + 15] !== null) ? (string) $row[$startcol + 15] : null;
			$this->fee = ($row[$startcol + 16] !== null) ? (string) $row[$startcol + 16] : null;
			$this->fee_paid = ($row[$startcol + 17] !== null) ? (string) $row[$startcol + 17] : null;
			...
			return $startcol + 21; // 21 = VisitPeer::NUM_COLUMNS - VisitPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[5] => $this->getRoomId(),
			$keys[6] => $this->getVisitType(),
			$keys[7] => $this->getBp(),
			$keys[8] => $this->getTemp(),
			$keys[9] => $this->getPulse(),
			$keys[10] => $this->getDiet(),
			$keys[11] => $this->getDescription(),
			$keys[12] => $this->getTime(),
			$keys[13] => $this->getVisitDate(),
			$keys[14] => $this->getAdmitDate(),
			$keys[15] => $this->getDischargeDate(),
			$keys[16] => $this->getFee(),
			$keys[17] => $this->getFeePaid(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[5], $arr)) $this->setRoomId($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setVisitType($arr[$keys[6]]);
		...
		if (array_key_exists($keys[10], $arr)) $this->setDiet($arr[$keys[10]]);
		if (array_key_exists($keys[11], $arr)) $this->setDescription($arr[$keys[11]]);
		if (array_key_exists($keys[12], $arr)) $this->setTime($arr[$keys[12]]);
		if (array_key_exists($keys[13], $arr)) $this->setVisitDate($arr[$keys[13]]);
		if (array_key_exists($keys[14], $arr)) $this->setAdmitDate($arr[$keys[14]]);
		if (array_key_exists($keys[15], $arr)) $this->setDischargeDate($arr[$keys[15]]);
		if (array_key_exists($keys[16], $arr)) $this->setFee($arr[$keys[16]]);
		if (array_key_exists($keys[17], $arr)) $this->setFeePaid($arr[$keys[17]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(VisitPeer::ROOM_ID)) $criteria->add(VisitPeer::ROOM_ID, $this->room_id);
