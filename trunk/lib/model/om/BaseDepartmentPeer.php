...
/**
 * Base static class for performing query and update operations on the 'department' table.
 *
 * 
 *
...
abstract class BaseDepartmentPeer {
	...
	/**
	 * An identiy map to hold any loaded instances of Department objects.
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Title', 'Status', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'title', 'status', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::TITLE, self::STATUS, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'title', 'status', 'created_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Title' => 1, 'Status' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'title' => 1, 'status' => 2, 'createdAt' => 3, 'updatedAt' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::TITLE => 1, self::STATUS => 2, self::CREATED_AT => 3, self::UPDATED_AT => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'title' => 1, 'status' => 2, 'created_at' => 3, 'updated_at' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new DepartmentMapBuilder();
		}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(DepartmentPeer::STATUS);
    ...
    foreach (sfMixer::getCallables('BaseDepartmentPeer:doCount:doCount') as $callable)
    {
	...
	{
		return DepartmentPeer::populateObjects(DepartmentPeer::doSelectStmt($criteria, $con));
	}
	/**
    ...
    foreach (sfMixer::getCallables('BaseDepartmentPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseDepartmentPeer', $criteria, $con);
    }
	 ...
	 *
	 * @param      mixed $value A Department object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof Department) {
				$key = (string) $value->getId();
			} elseif (is_scalar($value)) {
				// assume we've been passed a primary key
				$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or Department object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     Department Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseDepartmentPeer:doInsert:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($criteria->containsKey(DepartmentPeer::ID) && $criteria->keyContainsValue(DepartmentPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.DepartmentPeer::ID.')');
		}
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += DepartmentPeer::doOnDeleteCascade(new Criteria(DepartmentPeer::DATABASE_NAME), $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			DepartmentPeer::removeInstanceFromPool($values);
			...
			foreach ((array) $values as $singleval) {
				...
				DepartmentPeer::removeInstanceFromPool($singleval);
			}
		}
		...
		try {
			...
			// invalidate objects in DesignationPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related Designation objects
			$c = new Criteria(DesignationPeer::DATABASE_NAME);
			
			$c->add(DesignationPeer::DEPARTMENT_ID, $obj->getId());
			$affectedRows += DesignationPeer::doDelete($c, $con);

			// delete related Employee objects
			$c = new Criteria(EmployeePeer::DATABASE_NAME);
			
			$c->add(EmployeePeer::DEPARTMENT_ID, $obj->getId());
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = DepartmentPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
...
//
// NOTE: This static code cannot call methods on the DepartmentPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the DepartmentPeer class:
//
// Propel::getDatabaseMap(DepartmentPeer::DATABASE_NAME)->addTableBuilder(DepartmentPeer::TABLE_NAME, DepartmentPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseDepartmentPeer::DATABASE_NAME)->addTableBuilder(BaseDepartmentPeer::TABLE_NAME, BaseDepartmentPeer::getMapBuilder());
