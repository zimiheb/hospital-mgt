...
class BaseEmployeeForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'emp_category'      => new sfWidgetFormInput(),
      ...
      'visit_fee'         => new sfWidgetFormInput(),
    ...
    $this->setValidators(array(
      ...
      'emp_category'      => new sfValidatorString(array('max_length' => 10, 'required' => false)),
      ...
      'mail_address'      => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      ...
      'visit_fee'         => new sfValidatorInteger(array('required' => false)),
